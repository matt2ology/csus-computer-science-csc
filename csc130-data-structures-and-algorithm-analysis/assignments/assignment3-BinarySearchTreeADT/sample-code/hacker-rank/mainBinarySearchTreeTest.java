...
public class mainBinarySearchTreeTest {
    ...
    public static void main(String[] args) {
        ...
        /* create root */
        // tree.root.add(10); // Why doesn't this work?
        // tree.root.add(43); // Why doesn't this work?
        // tree.root.add(18); // Why doesn't this work?
        // tree.root.add(6); // Why doesn't this work?
        // tree.root.add(50); // Why doesn't this work?
        // tree.root.add(8); // Why doesn't this work?
