...
public class Employee {
	...
	public void setyearlySalary(double m) {
		/*********************************************************************
		 * If mthSalary is less than 0, then set mthSalary to 1000 value; otherwise, use
		 * the value placed in the argument.
		 *********************************************************************/
	...
	public void displayWarning() {
		...
		if (getMonthlySalary() < 0) {
			System.out.format(
					"***The inputed salary: $%.2f for %s %s is less than 0. %n" + "Salary set to $1000.00.***%n%n",
					getMonthlySalary(), getFirstName(), getLastName());
		}
	}

	public void display() {
		System.out.format("%s %s: Yearly Salary: $%.2f%n", getFirstName(), getLastName(), getyearlySalary());
	}
