...
public class SubHunterRefactored extends Activity {
    ...
    void draw() {
        ...
        canvas.drawText("Shots Taken: " + shotsTaken + "  Distance: " + distanceFromSub, blockSize, blockSize * 1.75f,
                paint);
    ...
    void boom() {
        ...
        canvas.drawText("Matthew Mendoza!", blockSize * 4, blockSize * 14, paint);
