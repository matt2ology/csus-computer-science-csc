...
public class Logism extends Activity {
        ...
        /*
         * This code will execute when a new game needs to be started. It will happen
         * when the app is first started and after the player wins a game.
         */
        void newGame() {
        ...
        void draw() {
                ...
                canvas.drawText("Shots Taken: " + shotsTaken + "  Distance: " + distanceFromSub, blockSize,
        ...
        void boom() {
                ...
                canvas.drawText("LOGISM!", blockSize * 4, blockSize * 14, paint);
