...
/**
 * Always sits on the bottom of the history stack. Acts as a place for the currentItem to rest
 * after the history's been exhausted. Provides feedback via the status bar if the buttons
 * keep being pressed.
 */
